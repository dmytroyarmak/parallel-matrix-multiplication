...
//   describe('productParallelInBuffer', function() {
//     it('is a function', function() {
//       expect(window.ParallelMatrixMultiplication.productParallelInBuffer).toEqual(jasmine.any(Function));
//     });
...
//           29, 30, 31, 32
//         ];
//         var buffer = Float64Array.from(matrixA.concat(matrixB, new Array(16).fill(0))).buffer;
//         resultPromise = window.ParallelMatrixMultiplication.productParallelInBuffer(buffer, 4);
//       });
